// Generated from /Users/huzhenyuan/workspace/CodeParser/src/main/resources/Solidity.g4 by ANTLR 4.7.2
package org.tron.smartcontract.tool;

import org.antlr.v4.runtime.ParserRuleContext;
import org.antlr.v4.runtime.tree.ErrorNode;
import org.antlr.v4.runtime.tree.TerminalNode;
import org.tron.smartcontract.tool.SolidityParser.EventParameterContext;
import org.tron.smartcontract.tool.SolidityParser.EventParameterListContext;
import org.tron.smartcontract.tool.SolidityParser.ParameterListContext;

/**
 * This class provides an empty implementation of {@link SolidityListener}, which can be extended to
...
public class SolidityBaseListener implements SolidityListener {
  ...
  public SolidityBaseListener(CodeParserTool codeParserTool) {
    tool = codeParserTool;
  }
  ...
  public void enterStateVariableDeclaration(SolidityParser.StateVariableDeclarationContext ctx) {
    if ("name".equals(ctx.identifier().getText())) {
      tool.setName(true);
    } else if ("symbol".equals(ctx.identifier().getText())) {
      tool.setSymbol(true);
    } else if ("decimals".equals(ctx.identifier().getText())) {
      tool.setDecimals(true);
    } else if ("totalSupply".equals(ctx.identifier().getText())) {
      tool.setTotalSupply(true);
    } else if ("balanceOf".equals(ctx.identifier().getText())) {
      tool.setBalanceOf(true);
    } else if ("transfer".equals(ctx.identifier().getText())) {
      tool.setTransfer(true);
    } else if ("transferFrom".equals(ctx.identifier().getText())) {
      tool.setTransferFrom(true);
    } else if ("approve".equals(ctx.identifier().getText())) {
      tool.setApprove(true);
    } else if ("allowance".equals(ctx.identifier().getText())) {
      tool.setAllowance(true);
    }
  }
  ...
  public void enterFunctionDefinition(SolidityParser.FunctionDefinitionContext ctx) {
    if (ctx.identifier() != null) {
      if ("name".equals(ctx.identifier().getText())) {
        ParameterListContext paraList = ctx.parameterList();
        if (paraList.parameter().size() == 0) {
          tool.setName(true);
        }
      } else if ("symbol".equals(ctx.identifier().getText())) {
        ParameterListContext paraList = ctx.parameterList();
        ...
        ParameterListContext paraList = ctx.parameterList();
        if (paraList.parameter().size() == 1) {
          tool.setBalanceOf(true);
        }
      } else if ("transfer".equals(ctx.identifier().getText())) {
        ParameterListContext paraList = ctx.parameterList();
        if (paraList.parameter().size() == 2) {
          tool.setTransfer(true);
        }
      } else if ("transferFrom".equals(ctx.identifier().getText())) {
        ParameterListContext paraList = ctx.parameterList();
        if (paraList.parameter().size() == 3) {
          tool.setTransferFrom(true);
        }
      } else if ("approve".equals(ctx.identifier().getText())) {
        ParameterListContext paraList = ctx.parameterList();
  ...
  public void enterEventDefinition(SolidityParser.EventDefinitionContext ctx) {
    if ("Transfer".equals(ctx.identifier().getText())) {
      EventParameterListContext paraList = ctx.eventParameterList();
      if (paraList.eventParameter().size() == 3) {
        EventParameterContext from = paraList.eventParameter().get(0);
        if ("address".equals(from.typeName().getText()) && "indexed"
            .equals(from.IndexedKeyword().getText())) {
        } else {
          return;
        }
        EventParameterContext to = paraList.eventParameter().get(1);
        if ("address".equals(to.typeName().getText()) && "indexed"
            .equals(to.IndexedKeyword().getText())) {
        } else {
          return;
        }
        tool.setTransferEvent(true);
      }
    } else if ("Approval".equals(ctx.identifier().getText())) {
      EventParameterListContext paraList = ctx.eventParameterList();
      if (paraList.eventParameter().size() == 3) {
        EventParameterContext from = paraList.eventParameter().get(0);
        if ("address".equals(from.typeName().getText()) && "indexed"
   ...
   */
  @Override
  public void enterVariableDeclarationStatement(
   ...
   */
  @Override
  public void enterAssemblyFunctionDefinition(
      SolidityParser.AssemblyFunctionDefinitionContext ctx) {
  }
   ...
   */
  @Override
  public void enterElementaryTypeNameExpression(
   ...
   */
  @Override
  public void exitElementaryTypeNameExpression(
      SolidityParser.ElementaryTypeNameExpressionContext ctx) {
  }
